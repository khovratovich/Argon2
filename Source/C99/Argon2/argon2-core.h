...
extern void InitBlockValue(uint8_t in);
extern void CopyBlock(block* dst, block* src);
extern void XORBlock(block* dst, block* src);
...
extern void InitInstance(Argon2_instance_t* instance_ptr, block* mem_ptr, Argon2_type t, uint32_t p , uint32_t m , uint8_t l );
...
extern void InitPosition(Argon2_position_t* position_ptr, uint32_t p, uint8_t l , uint8_t s , uint32_t i);
